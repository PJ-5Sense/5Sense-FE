...
export default function ClassFilter() {
    return (
        <div className="absolute left-12 top-[120px] w-[310px] h-[37px] items-start gap-2 inline-flex">
            <button className="group flex items-center gap-2 w-[112px] h-full border px-3 py-2 rounded-lg border-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 focus:outline focus:outline-2.5 focus:outline-[#D3C4F9]">
